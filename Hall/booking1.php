...
setcookie("r1",$_POST['t1']);
setcookie("r2",$_POST['t2']);
setcookie("r3",$_POST['t3']);
setcookie("r4",$_POST['email']);
setcookie("r5",$_POST['t5']);
setcookie("r6",$_POST['t6']);
setcookie("r7",$_POST['t7']);
...
{
	if($pn!="" && $pm!="" && $paddr!="" && $pemail!="" && $pgender!="" && $seqque!="" && $ans!="")
	{
		$rs=$conn->query("insert into person values('$pn','$pm','$paddr','$pemail','$pgender','$seqque','$ans')");
		if($rs)
		{
?>
<html>
